...
class HomeView extends GetView<HomeController> {
  final User userData = Get.find<User>();
  @override
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  SvgPicture.asset("assets/logo/simpati.svg")
                                ],
                              ),
                              SizedBox(
                                height: 20,
                              ...
                              RichText(
                                  text: TextSpan(
                                      text: "homepage-expire_date".tr + " ",
                                      style: TextStyle(
                                          color: Colors.white, fontSize: 16),
                                      children: [
                                    TextSpan(
                                      text: userData.numExpDate,
                                      style: TextStyle(
                                          color: Colors.white,
                                          fontWeight: FontWeight.bold,
                                          fontSize: 16),
                        ...
                        child: Row(
                          children: [
                            Card(
                              ...
                              data: userData.internet!,
                              satuan: "GB",
                            ),
                            Card(
                              title: "homepage-call".tr,
                              data: userData.telpon!,
                              satuan: "Min",
                            ),
                            Card(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              RoundedMenu(
                                  img: "assets/elements/home_internet.svg",
                                  title: "homepage-internet".tr),
                              RoundedMenu(
                                  img: "assets/elements/home_telpon.svg",
                                  title: "homepage-call".tr),
                              RoundedMenu(
                                  img: "assets/elements/home_pesan.svg",
                                  title: "homepage-sms".tr),
                              RoundedMenu(
                                  img: "assets/elements/home_roaming.svg",
                          ...
                          Row(
                            children: [
                              RoundedMenu(
                                  img: "assets/elements/home_hiburan.svg",
                                  title: "homepage-enternainment".tr),
                              RoundedMenu(
                                  img: "assets/elements/home_unggulan.svg",
                                  title: "homepage-superior".tr),
                              RoundedMenu(
                                  img: "assets/elements/home_tersimpan.svg",
                                  title: "homepage-saved".tr),
                              RoundedMenu(
                                  img: "assets/elements/home_riwayat.svg",
                            ...
                            child: ListView(
                              ...
                              children: [
                                CardImg(
                                    ...
                                    img: "assets/elements/banner_covid1.png"),
                                CardImg(
                                    title:
                                        "Bebas Kuota Akses Layanan Kesehatan",
                                    img: "assets/elements/banner_covid2.png"),
                              ],
                            ),
                          ),
                          SizedBox(
