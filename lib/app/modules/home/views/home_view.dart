...
class HomeView extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
        future:
            controller.fetchUserData(), // Replace with your data loading method
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            // Data has been loaded, display the main content
            return Scaffold(
              appBar: AppBar(
                centerTitle: false,
                title: RichText(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemCount: controller.bannerUri.length,
                                      // Replace with the actual length of your banner URLs array
